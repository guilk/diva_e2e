...
CLASS_INDEX_FILE = '../Class_Index_Detection.txt'
...
META_FILE='/mnt/sda/diva/thumos14/metadata/validation_set.mat'
data = sio.loadmat(META_FILE)['validation_videos'][0]

ANNOTATION_DIR = '/mnt/sda/diva/thumos14/annotations/TH14_Temporal_annotations_validation/annotation/'
annotation_files = os.listdir(ANNOTATION_DIR)

video_list = os.listdir('/mnt/sda/diva/thumos14/data/val/frames/')
video_db = {}
...
step = 128
# path = './preprocess/'
path = '/mnt/sda/diva/thumos14/data/'
stride=1
...
duration = []
for video in video_db:
  length = len(os.listdir('/mnt/sda/diva/thumos14/data/val/frames/'+video))
